...
def _build_version():
    return {
        ...
        "titles": [
            ...
            {
                "type": {"code": "C207615", "decode": "Brief Study Title"},
                "text": "Brief Test",
            },
        ],
    ...
    return {
        ...
        "contents": [
            ...
            },
            {
                "id": "nc-3",
                "sectionNumber": "3.1",
                "sectionTitle": "Primary Objective",
                "contentItemId": "nci-3",
                "previousId": "nc-2",
                "nextId": "nc-4",
            },
            {
                "id": "nc-4",
                "sectionNumber": "6.1",
                "sectionTitle": "Trial Intervention",
                "contentItemId": "nci-4",
                "previousId": "nc-3",
                "nextId": "nc-5",
            },
            {
                "id": "nc-5",
                "sectionNumber": "8.4",
                "sectionTitle": "Safety Assessments and Procedures",
                "contentItemId": "nci-5",
                "previousId": "nc-4",
                "nextId": "nc-6",
            },
            {
                "id": "nc-6",
                "sectionNumber": "9.3.2",
                "sectionTitle": "Adverse Events of Special Interest",
                "contentItemId": "nci-6",
                "previousId": "nc-5",
                "nextId": "nc-7",
            },
            ...
            },
            {
                "id": "nc-8",
                "sectionNumber": "10.4",
                "sectionTitle": "Analysis Associated with Primary",
                "contentItemId": "nci-8",
                "previousId": "nc-7",
                "nextId": "nc-9",
            },
