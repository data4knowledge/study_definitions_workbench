...
class TestUSDMDatabase:
    ...
    def mock_data_files(self):
        ...
        data_files.generic_path.return_value = ("/path/to/excel.xlsx", "excel.xlsx", False)
        return data_files
    ...
    def test_init(self, mocker, mock_session, mock_version, mock_file_import):
        ...
        mocker.patch("app.database.file_import.FileImport.find", return_value=mock_file_import)
        
        # Mock DataFiles constructor
        mock_data_files_init = mocker.patch("app.model.file_handling.data_files.DataFiles.__init__", return_value=None)
    ...
    def test_excel(self, mocker, mock_session, mock_version, mock_file_import, mock_data_files):
        ...
        mocker.patch("app.model.file_handling.data_files.DataFiles.__init__", return_value=None)
        mocker.patch("app.model.file_handling.data_files.DataFiles.path", return_value=("/path/to/usdm.json", "usdm.json", True))
        mocker.patch("app.model.file_handling.data_files.DataFiles.generic_path", return_value=("/path/to/excel.xlsx", "excel.xlsx", False))
        
        # Mock USDM4Excel
        mock_usdm4excel = MagicMock()
        mock_usdm4excel_class = mocker.patch("app.usdm_database.usdm_database.USDM4Excel", return_value=mock_usdm4excel)
        ...
        # Verify the result
        assert result == ("/path/to/excel.xlsx", "excel.xlsx", "application/vnd.ms-excel")
        
        # Verify the mocks were called correctly
        mock_usdm4excel_class.assert_called_once()
        mock_usdm4excel.to_excel.assert_called_once_with("/path/to/usdm.json", "/path/to/excel.xlsx")

    def test_excel_with_exception(self, mocker, mock_session, mock_version, mock_file_import):
        ...
        mocker.patch("app.usdm_database.usdm_database.USDM4Excel", return_value=mock_usdm4excel)
