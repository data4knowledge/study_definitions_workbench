...
def mock_check_fhir_version(mocker, path='app.routers.transmissions'):
  ...
  mock.side_effect = [('Mock V1', 'Mock Connectathon 1'), ('Mock V2', 'Mock Connectathon 2'), ('Mock V3', 'Mock Connectathon 3')]
  return mock

def mock_fhir_version_description(mocker, path='app.routers.transmissions'):
  mock = mocker.patch(f"{path}.fhir_version_description")
  mock.side_effect = ['Mock Connectathon 1', 'Mock Connectathon 2', 'Mock Connectathon 3']
  return mock
