...
class TestDataFiles:
    ...
    def mock_config(self, mocker):
        ...
        mock = mocker.patch("app.model.file_handling.data_files.application_configuration")
    ...
    def test_save_with_original_filename(self, data_files_with_uuid, mocker):
        ...
        mock_save_method = mocker.MagicMock(return_value="/test/data/path/test-uuid/test.xlsx")
        ...
        result, filename = data_files_with_uuid.save("xlsx", b"test content", "test.xlsx")
    ...
    def test_save_with_generated_filename(self, data_files_with_uuid, mocker):
        ...
        # Mock the specific save method
        mock_save_method = mocker.MagicMock(return_value="/test/data/path/test-uuid/usdm.json")
        ...
        mocker.patch.object(data_files_with_uuid, "_form_filename", return_value="usdm.json")
    ...
    def test_read(self, data_files_with_uuid, mocker):
        ...
        mocker.patch.object(data_files_with_uuid, "_form_filename", return_value="test.txt")
        mocker.patch.object(data_files_with_uuid, "_file_path", return_value="/test/data/path/test-uuid/test.txt")
        ...
        mock_open_file.assert_called_once_with("/test/data/path/test-uuid/test.txt", "r")
    ...
    def test_path_with_original_filename(self, data_files_with_uuid, mocker):
        ...
        mocker.patch.object(data_files_with_uuid, "_dir_files_by_extension", return_value=["test.xlsx"])
        
        # Mock the _file_path method
        mocker.patch.object(data_files_with_uuid, "_file_path", return_value="/test/data/path/test-uuid/test.xlsx")
    ...
    def test_path_with_multiple_files_error(self, data_files_with_uuid, mocker, mock_logger):
        ...
        mocker.patch.object(data_files_with_uuid, "_dir_files_by_extension", return_value=["test1.xlsx", "test2.xlsx"])
    ...
    def test_path_with_generated_filename_exists(self, data_files_with_uuid, mocker):
        ...
        # Mock the _file_path method
        mocker.patch.object(data_files_with_uuid, "_file_path", return_value="/test/data/path/test-uuid/usdm.json")
    ...
    def test_path_with_generated_filename_not_exists(self, data_files_with_uuid, mocker):
    ...
    def test_delete_success(self, data_files_with_uuid, mocker, mock_logger):
        ...
        mocker.patch.object(data_files_with_uuid, "_dir_path", return_value="/test/data/path/test-uuid")
    ...
    def test_clean_and_tidy_success(self, mock_config, mocker, mock_logger):
        ...
        mock_isfile.side_effect = [True, False, False, False]  # file1.txt is a file, others are directories
    ...
    def test_save_excel_file(self, data_files_with_uuid, mocker):
        ...
        mock_save_binary = mocker.patch.object(data_files_with_uuid, "_save_binary_file")
    ...
    def test_save_binary_file(self, data_files_with_uuid, mocker):
        ...
        # Mock the _file_path method
        mocker.patch.object(data_files_with_uuid, "_file_path", return_value="/test/data/path/test-uuid/test.bin")
        ...
        mock_open_file.assert_called_once_with("/test/data/path/test-uuid/test.bin", "wb")
        mock_open_file().write.assert_called_once_with(b"test content")

    def test_save_binary_file_exception(self, data_files_with_uuid, mocker, mock_logger):
    ...
    def test_save_image_file(self, data_files_with_uuid, mocker):
        ...
        # Mock the _file_path method
        mocker.patch.object(data_files_with_uuid, "_file_path", return_value="/test/data/path/test-uuid/image.png")
        ...
        mock_open_file.assert_called_once_with("/test/data/path/test-uuid/image.png", "wb")
        mock_open_file().write.assert_called_once_with(b"test content")

    def test_save_json_file(self, data_files_with_uuid, mocker):
        """Test _save_json_file method."""
        # Mock the _file_path method
        mocker.patch.object(data_files_with_uuid, "_file_path", return_value="/test/data/path/test-uuid/test.json")
        ...
        result = data_files_with_uuid._save_json_file('{"test": "content"}', "test.json")
        
        assert result == "/test/data/path/test-uuid/test.json"
        data_files_with_uuid._file_path.assert_called_once_with("test.json")
        mock_open_file.assert_called_once_with("/test/data/path/test-uuid/test.json", "w", encoding="utf-8")
    ...
    def test_save_yaml_file(self, data_files_with_uuid, mocker):
        ...
        # Mock the _file_path method
        mocker.patch.object(data_files_with_uuid, "_file_path", return_value="/test/data/path/test-uuid/test.yaml")
        ...
        mock_open_file.assert_called_once_with("/test/data/path/test-uuid/test.yaml", "w")
        mock_yaml_dump.assert_called_once_with({"test": "content"}, mock_open_file(), default_flow_style=False)
    ...
    def test_save_pdf_file(self, data_files_with_uuid, mocker):
        ...
        # Mock the _file_path method
        mocker.patch.object(data_files_with_uuid, "_file_path", return_value="/test/data/path/test-uuid/test.pdf")
        ...
        mock_open_file.assert_called_once_with("/test/data/path/test-uuid/test.pdf", "w+b")
        mock_open_file().write.assert_called_once_with(b"test content")
    ...
    def test_save_html_file(self, data_files_with_uuid, mocker):
        ...
        # Mock the _file_path method
        mocker.patch.object(data_files_with_uuid, "_file_path", return_value="/test/data/path/test-uuid/test.html")
        ...
        mock_open_file.assert_called_once_with("/test/data/path/test-uuid/test.html", "w", encoding="utf-8")
    ...
    def test_save_csv_file(self, data_files_with_uuid, mocker):
        ...
        # Mock the _file_path method
        mocker.patch.object(data_files_with_uuid, "_file_path", return_value="/test/data/path/test-uuid/test.csv")
        ...
        mock_open_file.assert_called_once_with("/test/data/path/test-uuid/test.csv", "w", newline="")
        mock_csv_dict_writer.assert_called_once_with(mock_open_file(), fieldnames=["col1", "col2"])
    ...
    def test_save_csv_file_empty_contents(self, data_files_with_uuid, mocker):
        ...
        data_files_with_uuid._file_path.assert_called_once_with("test.csv")
        mock_open_file.assert_called_once_with("/test/data/path/test-uuid/test.csv", "w", newline="")
        mock_csv_dict_writer.assert_called_once_with(mock_open_file(), fieldnames=["message"])
        mock_dict_writer.writeheader.assert_called_once()
    ...
    def test_dir_files_by_extension(self, data_files_with_uuid, mocker):
        ...
        mocker.patch.object(data_files_with_uuid, "_dir_files", return_value=["file1.txt", "file2.txt", "file3.csv"])
        
        # Mock the _extension method
        mocker.patch.object(data_files_with_uuid, "_extension", side_effect=lambda f: f.split(".")[-1])
