...
def test_load_m11(playwright: Playwright) -> None:
  ...
  page.locator("#files").set_input_files("ICH_M11_Template_RadVax_Example_Mods.docx")
  page.get_by_role("button", name=" Upload File(s)").click()
  page.get_by_role("link").first.click()
  page.get_by_role("button", name=" Import").click()
  page.get_by_role("link", name="M11 Document (.docx)").click()
  page.locator("#files").click()
  page.locator("#files").set_input_files("ICH_M11_Template_LZZT_Example_Estimand.docx")
  page.get_by_role("button", name=" Upload File(s)").click()
  page.get_by_role("button", name="Home").click()
  page.get_by_role("button", name=" Import").click()
  page.get_by_role("link", name="M11 Document (.docx)").click()
  page.locator("#files").click()
  page.locator("#files").set_input_files("ICH_M11_Template_IGBJ_Example_Estimand.docx")
  page.get_by_role("button", name=" Upload File(s)").click()
  page.get_by_role("link").first.click()
  context.close()
  browser.close()
